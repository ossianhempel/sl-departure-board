---
name: turborepo
description: "Turborepo monorepo guidance. Triggers: turbo.json, task pipelines, dependsOn, cache, remote cache, turbo CLI, --filter, --affected, CI, env vars, packages/apps."
metadata:
